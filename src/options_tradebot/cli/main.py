...
def main() -> int:
    ...
    if args.command == "backtest":
        frame = load_snapshot_csv(args.snapshots)
        result = OptionBacktester(default_settings()).run(frame, output_dir=args.output_dir)
    ...
    if args.command == "paper":
        ...
        service = PaperTradingService(settings=default_settings(), output_dir=args.output_dir)
